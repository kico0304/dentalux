    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Kontaktirajte nas</span>
          <h1 class="text-capitalize mb-5 text-lg">Tu smo za Vas</h1>
        </div>
      </div>
    </div>
  </div>
         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="contact-block mb-4 mb-lg-0">
                    ...
                    <h5>Lokacija</h5>
                    Ranka Miličevića 26 78000 Banja Luka
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="contact-form" class="contact__form " method="post" action="mail.php">
                 <!-- form message -->
                    ...
                    <div class="form-group-2 mb-4">
                        <textarea name="message" id="message" class="form-control" rows="8" placeholder="Vaša poruka"></textarea>
                    </div>

                    <div class="text-center">
                        <input class="btn btn-main btn-round-full" name="submit" type="submit" value="Pošalji poruku"></input>
                    </div>
                </form>
            </div>
        </div>
 ...
 <div class="google-map ">
    <div class="mapouter">
        <div class="gmap_canvas">
            <iframe height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=44.78175099788808,%2017.192948981477095&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
